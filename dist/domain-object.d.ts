 ...
 */
export type SerializedValue<V> = V extends null | undefined ? null : V extends DomainObject<object, never> ? ReturnType<V["serialize"]> : V extends Date ? string : V extends Map<unknown, unknown> | Set<unknown> | Promise<unknown> ? never : V extends ReadonlyArray<infer E> ? Array<SerializedArrayElement<E>> : V extends object ? JsonClonedValue<V> : V;
/**
 ...
 */
type SerializedArrayElement<E> = E extends null | undefined ? null : E extends DomainObject<object, never> ? ReturnType<E["serialize"]> : E extends Date ? string : E extends Map<unknown, unknown> | Set<unknown> | Promise<unknown> ? never : E extends ReadonlyArray<infer E2> ? Array<JsonClonedValue<E2>> : E extends object ? JsonClonedValue<E> : E;
/**
 ...
 */
type JsonClonedValue<V> = V extends null | undefined ? null : V extends DomainObject<object, never> ? never : V extends Date ? string : V extends Map<unknown, unknown> | Set<unknown> | Promise<unknown> ? never : V extends ReadonlyArray<infer E> ? Array<JsonClonedValue<E>> : V extends object ? {
 ...
 */
export type DomainObjectDataShape<TThis extends object, TDataKeys extends keyof TThis> = Schema<TThis, TDataKeys> & IllegalDataKeys<TThis, TDataKeys>;
/**
...
export type DomainObjectSerialized<TThis extends object, TDataKeys extends keyof TThis> = {
    [P in TDataKeys]: SerializedValue<TThis[P]>;
} & {
    $typename: string;
};
/**
 ...
 * ```
 */
export declare abstract class DomainObject<TThis extends object, TDataKeys extends keyof TThis> extends Serializable<DomainObjectSerialized<TThis, TDataKeys>> {
     ...
     */
    readonly $data?: DomainObjectDataShape<TThis, TDataKeys>;
    /**
